...
Figure below shows the order inwhich nodes are expanded. ![Order in which the nodes are expanded](https://upload.wikimedia.org/wikipedia/commons/3/33/Breadth-first-tree.svg)
